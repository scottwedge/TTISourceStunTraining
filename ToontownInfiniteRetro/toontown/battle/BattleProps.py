...
class PropPool:
    ...
    def __init__(self):
        ...
        self.propTypes[propName] = 'model'
        propName = 'toonhall'
        self.propStrings[propName] = ('phase_4/models/modules/toonhall',)
        self.propTypes[propName] = 'model'
        propName = 'clownfish'
        self.propStrings[propName] = ('phase_4/models/char/clownFish-zero',)
        self.propTypes[propName] = 'model'
        propName = 'ceo'
        self.propStrings[propName] = ('phase_12/models/char/bossbotBoss-head-zero',)
        self.propTypes[propName] = 'model'
        propName = 'robota'
        self.propStrings[propName] = ('phase_5/models/char/cogA_robot-zero',)
        self.propTypes[propName] = 'model'
        propName = 'luredb'
        self.propStrings[propName] = ('phase_4/models/char/suitA-heads',)
        self.propTypes[propName] = 'model'
        propName = 'fla'
        self.propStrings[propName] = ('phase_14/models/fla',)
        self.propTypes[propName] = 'model'
        propName = 'rover'
        self.propStrings[propName] = ('phase_14/models/kitchen',)
        self.propTypes[propName] = 'model'
        propName = 'cathead'
        self.propStrings[propName] = ('phase_3/models/char/cat-heads-1000',)
        self.propTypes[propName] = 'model'
