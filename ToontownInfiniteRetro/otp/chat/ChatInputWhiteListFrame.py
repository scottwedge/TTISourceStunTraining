...
class ChatInputWhiteListFrame(FSM.FSM, DirectFrame):
    ...
    def __init__(self, entryOptions, parent = None, **kw):
        ...
        DirectFrame.__init__(self, parent=aspect2dp, pos=(0, 0, 0.3), relief=None, image=DGG.getDefaultDialogGeom(), image_scale=(3.7, 1.7, 3.1), image_pos=(0, 0, -0.05), image_color=OTPGlobals.GlobalDialogColor, borderWidth=(0.01, 0.01))
        ...
        self.chatEntry = DirectEntry(parent=self,
                                     relief = DGG.SUNKEN,
                                     scale=0.05,
                                     frameSize=(-0.2,0.3,-0.5,1.2),
                                     borderWidth= (0.1,0.1),
                                     frameColor=(0.9,0.9,0.85,0.8),
                                     pos=(-0.2,0,0.11),
                                     entryFont=OTPGlobals.getInterfaceFont(),
